...
class Splitter( Element ):
    ...
    def __init__( spl, name ):
        ...
        # Variables
        spl.BPR = RealT( spl, v=1., units="none", desc="Bypass ratio, W2/W1" )
        ...
        spl.size = BooleanT( spl, v=True, desc="Determine if the element is in design mode or not" )


        # solver stuff
        spl.ind_BPR = Independent( spl, indname="BPR", perturb=.05, scale=100, perturb_type="Relative", active=False, desc="Bypass Ratio" )        
