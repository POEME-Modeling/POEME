...
class Air4:
    """Air property lookup table using 3D interpolation with session object.
    ...
    precomputed data stored in ``air2_data.npz``. This class includes convergence
