...
class Burner(Element):
    def __init__(self, name, session: ModelSession | None = None):
        ...
        # element description
        self.desc = (
            "Burner - This is a conventional buner.  It takes a flow and performs a\n"
        )
        self.desc += (
            "a combustion calculation.  The user can either input desired fuel to air\n"
        )
        self.desc += (
            "ratio or the desired fuel flow.  WFset is a true or false switch.  It is\n"
        )
        self.desc += (
            "set the true then the element runs to the input fuel flow.  It is set to\n"
        )
        ...
        self.desc += (
            "input LHV actual represents the energy of the fuel including the heat of\n"
        )
        self.desc += (
            "formation.  In this case hydrocaron fuel would have a negative LHV value\n"
        )
