...
class FlightConditionsSMJ(Element):
    """Flight conditions element using altitude and Mach number input.

    Starts a flow stream by taking in user input values of altitude and
    Mach number and transforming them into total and static flow conditions
    in the fluid exit node. The values of static temperature and pressure
    are determined from atmospheric tables.
    ...
    def __init__(self, name, session: ModelSession | None = None):
        ...
        self.desc = "FlightConditionsSMJ - Start a Flow stream using input values by "
        "taking in the user input values of altitude and Mach number and transforming "
        "it into a total and static flow condition in the fluid exit node.\nThe values "
        "of static temperature and pressure are determined from atmospheric tables."
        ...
        # self.TTcalc = RealT(self, units="R", desc="temperature")
        # self.PTcalc = RealT(self, units="lbf/in2", desc="pressure")
        self.size = BooleanT(
    ...
    def calc(self):
        ...
        # self.Fram = self.FNo.V * self.FNo.W / 32.174
    ...
    def precheck(self):
        ...
        mass flow is fixed by user input. In off-design mode, it is
        activated so the solver can adjust the mass flow.
        """
    ...
    def dump(self, output_file):
        """Dump flight conditions SMJ state to an output file.

        Parameters
        ----------
        output_file : file-like
            File object to write the flight conditions SMJ state to.
        """
    ...
    def pretty(self, output_file):
        """Print a formatted summary of the flight conditions SMJ state.
