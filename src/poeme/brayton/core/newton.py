...
class Newton(Element):
    def __init__(self, name, output_file=None, session: ModelSession | None = None):
        ...
        self.desc = (
            "Newton is a Newton Rhapson solver.  It is used to balance the models\n"
        )
        self.desc += (
            "by varying the independents in the models such that the dependents and\n"
        )
        self.desc += (
            "are satisfied.  The number of independents and dependents/states need to\n"
        )
        self.desc += (
