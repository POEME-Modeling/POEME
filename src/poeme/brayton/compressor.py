...
class Compressor(Element):
    def __init__(self, name, session: ModelSession | None = None):
        ...
        self.hfract1 = RealT(
            self,
            units="BTU/lbm",
            desc="Enthalpy fraction (0=entrance, 1=exit) for the location of bleed flow 1",
        )
        self.hfract2 = RealT(
            self,
            units="BTU/lbm",
            desc="Enthalpy fraction (0=entrance, 1=exit) for the location of bleed flow 2",
        )
        ...
        self.desc += (
            "value of 1.0 indicates the bleed is take off at the compressor exit.\n\n"
        )
