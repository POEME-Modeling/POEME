...
class Dependent(Atom):
    ...
    **kwargs : dict
    ...
    def __init__(self, p, **kwargs):
        ...
        "met for the model to be considered valid. It described by two references to "
        "variables that have to be equal for the solution to be valid. And example "
        "would be the flow leaving a nozzle element where the flow going out of the "
        "nozzle must equal the flow coming in."
