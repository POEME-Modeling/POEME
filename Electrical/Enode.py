...
class Enode( Element ):
    ...
    def __init__( e,name ):
        ...
        e.desc = "This element is an electrical node location.  It has a voltage " \
        ...
        #solver stuff
        e.ind_1 = Independent( e, indname="Vr", perturb=.05, scale=100, perturb_type="Relative", active=True, desc="Varies real component of Voltage" )
        e.ind_2 = Independent( e, indname="Vi", perturb=.05, scale=100, perturb_type="Relative", active=True, desc="Varies imaginary component of Voltage" )
        e.dep_1 = Dependent( e, d1name="IinR", d2name="IoutR", val_scale=1.0, active=True, desc="Balances real component of current" )
        e.dep_2 = Dependent( e, d1name="IinI", d2name="IoutI", val_scale=1.0, active=True, desc="Balances imaginary component of current" )
    ...
    def calc( e ):
        ...
        for p in e.port_list:
            if p.I.v.real > 0:
                e.IinR.set( e.IinR + p.I.v.real )
            else:
                e.IoutR.set( e.IoutR - p.I.v.real )
            if p.I.v.imag > 0:
                e.IinI.set( e.IinI + p.I.v.imag )
            else:
